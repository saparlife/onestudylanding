        ...
        <div className="grid md:grid-cols-4 gap-12 pb-12 border-b border-gray-800">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://instagram.com/1study.kz" className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-indigo-600 transition">
              ...
              <a href="https://wa.me/77001234567" className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-green-600 transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
