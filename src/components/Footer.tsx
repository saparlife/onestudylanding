      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-2">
            <a href="/" className="text-3xl font-extrabold gradient-text inline-block mb-4">
              1Study
            </a>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a href="https://wa.me/77476899983" className="w-10 h-10 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center hover:bg-green-600 hover:border-green-600 transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                onClick={toggleTheme}
                className="w-10 h-10 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center hover:bg-white/10 hover:border-white/20 transition"
