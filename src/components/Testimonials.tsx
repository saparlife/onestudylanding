  ...
  const testimonials = [
    {
      ...
      image: "/testimonials/person1.jpg", // Заменить на реальное фото
    ...
    },
    {
      ...
      image: "/testimonials/person2.jpg", // Заменить на реальное фото
    ...
    },
    {
      ...
      image: "/testimonials/person3.jpg", // Заменить на реальное фото
          ...
          <div className="bg-white/5 backdrop-blur border border-white/10 rounded-3xl p-8 sm:p-12">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-indigo-400 text-sm">{testimonials[activeIndex].followers}</p>
              </div>
            </div>
          </div>
        </div>
