        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-400 mb-8">
              Ваши ученики смогут учиться с телефона. Уведомления, тёмная тема,
              защита от записи экрана — всё включено.
            </p>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-300">Push-уведомления о новых уроках</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-green-500/20 flex items-center justify-center">
                  <svg className="w-4 h-4 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-300">Тёмная и светлая тема</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-green-500/20 flex items-center justify-center">
                  <svg className="w-4 h-4 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-300">Офлайн просмотр материалов</span>
              </li>
            </ul>
            ...
            <div className="relative">
              ...
              <div className="absolute -right-8 top-8 w-48 h-96 rounded-[2.5rem] bg-gray-800 border-4 border-gray-700 shadow-2xl transform rotate-6 opacity-50">
                <div className="absolute inset-2 rounded-[2rem] bg-gradient-to-b from-gray-900 to-gray-800 flex items-center justify-center">
                  <span className="text-gray-600 text-xs">Экран 2</span>
                </div>
              </div>
