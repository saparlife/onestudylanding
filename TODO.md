...
- [ ] **DNS настройка** - в ps.kz:
  - Изменить A запись с `195.210.46.33` на `76.76.21.21`
  - Или добавить CNAME `cname.vercel-dns.com`
  - Ждать до 48ч на распространение

- [ ] **SSL** - автоматически выдаст Vercel после привязки домена
